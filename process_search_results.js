  ...
  try {
    ...
    for (const result of searchResults) {
      const prompt = `
        ...
        First name, Last name, Education, Employer, Location, Other experiences & important facts. If you don't find data, please return empty string. Format location always: "City, Country"
      ...
      const { data, error: insertError } = await supabase
        ...
        .insert({
          link: result.link,
          first_name: structuredData.firstName,
          last_name: structuredData.lastName,
