  ...
  try {
    ...
    for (const result of unprocessedResults) {
      ...
      const prompt = `
        ...
        Education, Former Employers, Location, previous professional experiences or job & important facts. If you don't find data, please return empty string. Format location always: "City, Country". Please only provide university name (no sub-degrees or sub schools).
